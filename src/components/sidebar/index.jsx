  ...
  return (
    <Sidebar className={`${navbarShrink ? 'w-[4rem]' : ''} side-bar h-screen sticky top-0 left-0 bottom-0 shadow border-r border-[gainsboro] dark:border-r dark:border-gray-700`}>
      ...
      <div className="flex items-center">
        <img width={40} src={logoImage} style={{filter: "invert(1)"}} className="dark:hidden" alt="Your Company Logo" />
        <img width={40} src={logoImage} className="dark:block hidden" alt="Your Company Logo" />
  
      {!navbarShrink &&
        <p className="ml-2 text-sm">Avenue5 Overview </p>
      }
      </div>
      </Sidebar.Logo>
